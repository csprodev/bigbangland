	...
	<div class="container">
		<h3>Blog</h3>
   			<div class="col-md-9 blog-head">
	    		<div class="blog-top">
	         		<a href="<?php echo site_url('index.php/home/blogsingle')?>"><img src="images/bl.jpg" class="img-responsive" alt=""/></a>
	         		<h4><a href="<?php echo site_url('index.php/home/blogsingle')?>">Blog Heading Here</a></h4>
	         		<h5>Posted By : <a href="<?php echo site_url('index.php/home/blogsingle')?>">Ipsum</a> | Date : 03-03-2015</h5>
	        		<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make. a type specimen book. It has survived not only five centuries. but also the leap into electronic typesetting, remaining essentially unchanged. There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, </p>
	         		<a class="hvr-sweep-to-right more" href="<?php echo site_url('index.php/home/blogsingle')?>">Read More</a>
           			<div class="links">
						<ul class="blog-links">
		  		...
		  		<div class="blog-top">
					<a href="<?php echo site_url('index.php/home/blogsingle')?>"><img src="images/bl1.jpg" class="img-responsive" alt=""/></a>
					<h4><a href="<?php echo site_url('index.php/home/blogsingle')?>">Blog Heading Here</a></h4>
					<h5>Posted By : <a href="<?php echo site_url('index.php/home/blogsingle')?>">Ipsum</a> | Date : 03-03-2015</h5>
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make. a type specimen book. It has survived not only five centuries. but also the leap into electronic typesetting, remaining essentially unchanged. There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, </p>
					<a class="hvr-sweep-to-right more" href="<?php echo site_url('index.php/home/blogsingle')?>">Read More</a>
		  		...
		  		<div class="blog-top">
					<a href="<?php echo site_url('index.php/home/blogsingle')?>"><img src="images/bl2.jpg" class="img-responsive" alt=""/></a>
					<h4><a href="<?php echo site_url('index.php/home/blogsingle')?>">Blog Heading Here</a></h4>
					<h5>Posted By : <a href="<?php echo site_url('index.php/home/blogsingle')?>">Ipsum</a> | Date : 03-03-2015</h5>
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the when an unknown printer took a galley of type and scrambled it to make. a type specimen book. It has survived not only five centuries. but also the leap into electronic typesetting, remaining essentially unchanged. There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, </p>
					<a class="hvr-sweep-to-right more" href="<?php echo site_url('index.php/home/blogsingle')?>">Read More</a>
			...
			<div class="col-md-3 blog-sidebar">
				<div class="blog-list">
		 		...
		 		<div class="blog-list1">
					...
					<div class="blog-list-top">
						<div class="blog-img">
							<a href="<?php echo site_url('index.php/home/blogsingle')?>"><img class="img-responsive" src="images/bo.jpg" alt=""></a>
						</div>
						<div class="blog-text">
				...
				<div class="blog-list-top">
					<div class="blog-img">
						<a href="<?php echo site_url('index.php/home/blogsingle')?>"><img class="img-responsive" src="images/bo1.jpg" alt=""></a>
					</div>
					<div class="blog-text">
						<p ><a href="<?php echo site_url('index.php/home/blogsingle')?>">Lorem ipsum dolor sit amet, consectetuer</a></p>
						<span class="link">
							Feb 14, 2015
							<a href="#">
								<i class="glyphicon glyphicon-heart"> </i>
				...
				<div class="blog-list-top">
					<div class="blog-img">
						<a href="<?php echo site_url('index.php/home/blogsingle')?>"><img class="img-responsive" src="images/bo2.jpg" alt=""></a>
					</div>
					<div class="blog-text">
						<p ><a href="<?php echo site_url('index.php/home/blogsingle')?>">Lorem ipsum dolor sit amet, consectetuer</a></p>
						<span class="link">
				...
				<div class="blog-list-top">
					<div class="blog-img">
						<a href="<?php echo site_url('index.php/home/blogsingle')?>"><img class="img-responsive" src="images/bo3.jpg" alt=""></a>
					</div>
					<div class="blog-text">
						<p ><a href="<?php echo site_url('index.php/home/blogsingle')?>">Lorem ipsum dolor sit amet, consectetuer</a></p>
						<span class="link">
				...
				<div class="blog-list-top">
					<div class="blog-img">
						<a href="<?php echo site_url('index.php/home/blogsingle')?>"><img class="img-responsive" src="images/bo4.jpg" alt=""></a>
					</div>
					<div class="blog-text">
						<p ><a href="<?php echo site_url('index.php/home/blogsingle')?>">Lorem ipsum dolor sit amet, consectetuer</a></p>
						<span class="link">
